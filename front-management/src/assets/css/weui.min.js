    ...
    return function(e) {
        ...
        function a() {
            ...
            n = r.default.extend({ title: null, content: "", className: "", buttons: [{ label: "确定", type: "primary", onClick: r.default.noop }], isAndroid: i }, n); var a = (0, r.default)(r.default.render(l.default, n)),
                ...
                u = a.find(".weui-mask"); return (0, r.default)("body").append(a), u.addClass("weui-animate-fade-in"), o.addClass("weui-animate-fade-in"), a.on("click", ".weui-dialog__btn", function(e) { var i = (0, r.default)(this).index();
        ...
        function a() {
            ...
            a = r.default.extend({ menus: n, actions: i, className: "", isAndroid: o }, a); var u = (0, r.default)(r.default.render(l.default, a)),
                d = u.find(".weui-actionsheet"),
                f = u.find(".weui-mask"); return (0, r.default)("body").append(u), r.default.getStyle(d[0], "transform"), d.addClass(o ? "weui-animate-fade-in" : "weui-animate-slide-up"), f.addClass("weui-animate-fade-in").on("click", function() { t() }), u.find(".weui-actionsheet__menu").on("click", ".weui-actionsheet__cell", function(e) { var i = (0, r.default)(this).index();
        ...
        function o(e, t, n) { var i = e[0],
                a = e.val(); if ("INPUT" == i.tagName || "TEXTAREA" == i.tagName) { var o = i.getAttribute("pattern") || ""; if ("radio" == i.type) { for (var r = t.find('input[type="radio"][name="' + i.name + '"]'), u = 0, l = r.length; u < l; ++u)
                    ...
                    return "empty" } if ("checkbox" != i.type) { if (e.val().length) { if (o) { if (/^REG_/.test(o)) { if (!n) throw "RegExp " + o + " is empty."; if (o = o.replace(/^REG_/, ""), !n[o]) throw "RegExp " + o + " has not found.";
                                o = n[o] } return new RegExp(o).test(a) ? null : "notMatch" } return null } return "empty" } if (!o) return i.checked ? null : "empty"; var d = function() { var e = t.find('input[type="checkbox"][name="' + i.name + '"]'),
                        n = o.replace(/[{\s}]/g, "").split(","),
                        a = 0; if (2 != n.length) throw i.outerHTML + " regexp is wrong."; return e.forEach(function(e) { e.checked && ++a }), a ? "" === n[1] ? a >= parseInt(n[0]) ? { v: null } : { v: "notMatch" } : parseInt(n[0]) <= a && a <= parseInt(n[1]) ? { v: null } : { v: "notMatch" } : { v: "empty" } }(); if ("object" === ("undefined" == typeof d ? "undefined" : s(d))) return d.v } else if (a.length) return null; return "empty" }

        function r(e) { if (e) { var t = (0, f.default)(e.ele),
                    n = e.msg,
        ...
        function u(e) { var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : f.default.noop,
                n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                i = (0, f.default)(e); return i.forEach(function(e) { var i = (0, f.default)(e),
                    a = i.find("[required]"); "function" != typeof t && (t = r); for (var u = 0, l = a.length; u < l; ++u) { var s = a.eq(u),
                        d = o(s, i, n.regexp),
                        c = { ele: s[0], msg: d }; if (d) return void(t(c) || r(c)) }
                t(null) }), this }
        ...
        function l(e) { var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                n.find("[required]").on("blur", function() { if ("checkbox" != this.type && "radio" != this.type) { var e = (0, f.default)(this); if (!(e.val().length < 1)) { var i = o(e, n, t.regexp);
                            i && r({ ele: e[0], msg: i }) } } }).on("focus", function() { var e = a(this);
        ...
        function a(e, t) {
            ...
            t = r.default.extend({ url: "", auto: !0, type: "file", fileVal: "file", onBeforeQueued: r.default.noop, onQueued: r.default.noop, onBeforeSend: r.default.noop, onSuccess: r.default.noop, onProgress: r.default.noop, onError: r.default.noop }, t), t.compress !== !1 && (t.compress = r.default.extend({ width: 1600, height: 1600, quality: .8 }, t.compress)), t.onBeforeQueued && ! function() { var e = t.onBeforeQueued;
                t.onBeforeQueued = function(t, n) { var i = e.call(t, n); if (i === !1) return !1; if (i !== !0) { var a = (0, r.default)(r.default.render(l.default, { id: t.id }));
                        o.find(".weui-uploader__files").append(a) } } }(), t.onQueued && ! function() { var e = t.onQueued;
                t.onQueued = function(n) { if (!e.call(n)) { var a = o.find('[data-id="' + n.id + '"]');
                        a.css({ backgroundImage: 'url("' + (n.base64 || n.url) + '")' }), t.auto || i(o, n.id) } } }(), t.onBeforeSend && ! function() { var e = t.onBeforeSend;
                t.onBeforeSend = function(t, n, i) { var a = e.call(t, n, i); if (a === !1) return !1 } }(), t.onSuccess && ! function() { var e = t.onSuccess;
                t.onSuccess = function(t, n) { t.status = "success", e.call(t, n) || i(o, t.id) } }(), t.onProgress && ! function() { var e = t.onProgress;
                t.onProgress = function(t, i) { e.call(t, i) || n(o, t.id).html(i + "%") } }(), t.onError && ! function() { var e = t.onError;
                t.onError = function(t, i) { t.status = "fail", e.call(t, i) || n(o, t.id).html('<i class="weui-icon-warn"></i>') } }(), o.find('input[type="file"]').on("change", function(e) { var n = e.target.files;
        ...
        function u(e, t, u) { var l = new FileReader;
            l.onload = function(l) { if (t.compress === !1) return e.base64 = l.target.result, void u(e); var s = new Image;
                s.onload = function() { var l = n(s),
                        ...
                        v = s.width,
                        m = s.height,
                        w = void 0; if (v < m && m > h ? (v = parseInt(h * s.width / s.height), m = h) : v >= m && v > p && (m = parseInt(p * s.height / s.width), v = p), f.width = v, f.height = m, d > 0 && r(f, c, d), c.drawImage(s, 0, 0, v, m / l), w = /image\/jpeg/.test(e.type) || /image\/jpg/.test(e.type) ? f.toDataURL("image/jpeg", t.compress.quality) : f.toDataURL(e.type), "file" == t.type)
        ...
        function n(e) { var t = e.url,
                ...
                c = {}; if (a(n, f, c) !== !1) { n.status = "progress", o(n, 0); var p = new FormData,
                    h = new XMLHttpRequest;
                n.xhr = h, Object.keys(f).forEach(function(e) { p.append(e, f[e]) }), "file" == e.type ? p.append(i, n, l) : p.append(i, n.base64), h.onreadystatechange = function() { if (4 == h.readyState)
                        if (200 == h.status) try { var e = JSON.parse(h.responseText);
                            u(n, e) } catch (e) { r(n, e) } else r(n, new Error("XMLHttpRequest response status is " + h.status)) }, h.upload.addEventListener("progress", function(e) { if (0 != e.total) { var t = 100 * Math.ceil(e.loaded / e.total);
        ...
        function r() {
            ...
            function i(e, t) { if (void 0 === c[t] && r.defaultValue && void 0 !== r.defaultValue[t]) { for (var n = r.defaultValue[t], a = 0, u = e.length; a < u && n != e[a].value; ++a);
                    a < u && (c[t] = a) }
                h.find(".weui-picker__group").eq(t).scroll({ items: e, temp: c[t], onChange: function(e, n) { if (e ? f[t] = new o(e) : f[t] = null, c[t] = n, l) r.onChange(f);
                        else if (e.children && e.children.length > 0) h.find(".weui-picker__group").eq(t + 1).show(), !l && i(e.children, t + 1);
                        else { var a = h.find(".weui-picker__group");
                            a.forEach(function(e, n) { n > t && (0, s.default)(e).hide() }), f.splice(t + 1), r.onChange(f) } }, onConfirm: r.onConfirm }) } if (_) return _; var a = arguments[arguments.length - 1],
                r = s.default.extend({ id: "default", className: "", onChange: s.default.noop, onConfirm: s.default.noop }, a),
                u = void 0,
                l = !1; if (arguments.length > 2) { var d = 0; for (u = []; d < arguments.length - 1;) u.push(arguments[d++]);
                l = !0 } else u = arguments[0];
            g[r.id] = g[r.id] || []; for (var f = [], c = g[r.id], h = (0, s.default)(s.default.render(v.default, r)), m = a.depth || (l ? u.length : p.depthOf(u[0])), y = ""; m--;) y += w.default; return h.find(".weui-picker__bd").html(y), e(), l ? u.forEach(function(e, t) { i(e, t) }) : i(u, 0), h.on("click", ".weui-mask", function() { n() }).on("click", ".weui-picker__action", function() { n() }).on("click", "#weui-picker-confirm", function() { r.onConfirm(f) }), _ = h[0], _.hide = n, _ }

        function u(e) { var t = s.default.extend({ id: "datePicker", onChange: s.default.noop, onConfirm: s.default.noop, start: 2e3, end: 2030, cron: "* * *" }, e); "number" == typeof t.start ? t.start = new Date(t.start + "-01-01") : "string" == typeof t.start && (t.start = new Date(t.start)), "number" == typeof t.end ? t.end = new Date(t.end + "-12-31") : "string" == typeof t.end && (t.end = new Date(t.end)); var n = function(e, t, n) { for (var i = 0, a = e.length; i < a; i++) { var o = e[i]; if (o[t] == n) return o } },
                i = [],
                a = f.default.parse(t.cron, t.start, t.end),
                o = void 0;
            do { o = a.next(); var u = o.value.getFullYear(),
                    l = o.value.getMonth() + 1,
                    d = o.value.getDate(),
                    c = n(i, "value", u);
                c || (c = { label: u + "年", value: u, children: [] }, i.push(c)); var p = n(c.children, "value", l);
                p || (p = { label: l + "月", value: l, children: [] }, c.children.push(p)), p.children.push({ label: d + "日", value: d }) } while (!o.done); return r(i, t) }
        Object.defineProperty(t, "__esModule", { value: !0 }); var l = n(2),
            s = a(l),
            d = n(25),
            f = a(d);
        n(26); var c = n(27),
            ...
            m = n(29),
            w = a(m);
        o.prototype.toString = function() { return this.value }, o.prototype.valueOf = function() { return this.value }; var _ = void 0,
            g = {};
        ...
        var a = n(2),
            o = i(a),
            r = function(e, t) { return e.css({ "-webkit-transition": "all " + t + "s", transition: "all " + t + "s" }) },
            u = function(e, t) { return e.css({ "-webkit-transform": "translate3d(0, " + t + "px, 0)", transform: "translate3d(0, " + t + "px, 0)" }) },
            l = function(e) { for (var t = Math.floor(e.length / 2), n = 0; e[t] && e[t].disabled;)
                    if (t = ++t % e.length, n++, n > e.length) throw new Error("No selectable item.");
                return t },
            s = function(e, t, n) { var i = l(n); return (e - i) * t },
            d = function(e, t) { return e * t },
            f = function(e, t, n) { return -(t * (n - e - 1)) };
        o.default.fn.scroll = function(e) {
            function t(e) { m = e, _ = +new Date }

            function n(e) { w = e; var t = w - m;
                r(v, 0), u(v, g + t), _ = +new Date, y.push({ time: _, y: w }), y.length > 40 && y.shift() }

            function i(e) { if (m) { var t = (new Date).getTime(),
                        n = b - c.bodyHeight / 2; if (w = e, t - _ > 100) M(Math.abs(w - m) > 10 ? w - m : n - w);
                    else if (Math.abs(w - m) > 10) { for (var i = y.length - 1, a = i, o = i; o > 0 && _ - y[o].time < 100; o--) a = o; if (a !== i) { var r = y[i],
                                u = y[a],
                                l = r.time - u.time,
                                s = r.y - u.y,
                                d = s / l,
            ...
            var a = this,
                ...
                p = c.items.map(function(e) { return '<div class="weui-picker__item' + (e.disabled ? " weui-picker__item_disabled" : "") + '">' + e.label + "</div>" }).join(""),
                h = (0, o.default)(this);
            ...
            if (null !== c.temp && c.temp < c.items.length) { var k = c.temp;
                c.onChange.call(this, c.items[k], k), g = (c.offset - k) * c.rowHeight } else { var x = l(c.items);
                c.onChange.call(this, c.items[x], x), g = s(c.offset, c.rowHeight, c.items) }
            u(v, g);
            var M = function(e) { g += e, g = Math.round(g / c.rowHeight) * c.rowHeight; var t = d(c.offset, c.rowHeight),
                    n = f(c.offset, c.rowHeight, c.items.length);
                g > t && (g = t), g < n && (g = n); for (var i = c.offset - g / c.rowHeight; c.items[i] && c.items[i].disabled;) e > 0 ? ++i : --i;
